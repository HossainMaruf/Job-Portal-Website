    ...
    >
      ...
      <p class="lead text-light text-capitalize "><?php echo $_SESSION["ADMIN_FNAME"]; ?></p>
        <nav class="navbar-dark">
            ...
            <ul class="navbar-nav" >
            <li>
              <a href="admin_dashboard.php" class="nav-link px-3 active">
        ...
        <main class="mt-5 pt-3 ml-4 px-4">
           <div class="container">
              <div class="row">
                  ...
                  <?php
                      $sql = "SELECT * FROM tbl_jobs where status= 0 ORDER BY Id desc ";
                          ...
                          <div class="card-body m-1">
                           ...
                           <?php echo'<span class=""><i class="fas fa-hourglass-end"  ></i>  '.$row['Dead_line'].'</span>'?>
                            ...
                            <div class="mt-4 mb-2 ">
                              ...
                              <?php  
                                echo '<div class="m-2">
                                <form method="post" action="job_status_change.php">
                                 <input type="hidden" name="job_id" value="'.$row['Id'].'" />
                                 <input type="hidden" name="status" value="1"/>
                                 <input type="submit" value="Approved" class="btn btn-success mb-2 float-start "/>
                                </form>
                                </div>';
                                echo '<div class="m-2">
                                <form method="post" action="job_status_change.php">
                                  ...
                                  <input type="submit" value="Disapproved" class="btn btn-danger mb-2 float-end"/>
                                </form>
                                </div>';
                              ?>
