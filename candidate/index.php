...
//check if candidate is login or not. 
//If candidate is loged in then redirect him/her to dashboard
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if( isset($email) &&  isset($password) )
  {
    ...
    $sql = "SELECT * FROM tblemployee_reg WHERE Email='".$email."' AND Password='".$password."'";
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            $_SESSION["Candidate_FNAME"] = $row["FirstName"];
            $_SESSION["Candidate_LNAME"] = $row["LastName"];
            $_SESSION["Candidate_EMAIL"] = $row["Email"];
            $_SESSION["Candidate_ADDRESS"] = $row["Address"];
        }
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="candidate_reg.php">Candidate Registration</a></li>
                    <li><a class="dropdown-item" href="index.php">Candidate LogIn</a></li>
                    <li><a class="dropdown-item" href="candidate_dashboard.php">Candidate Dashboard</a></li>
                  </ul>
                </li>
                <li class="nav-item">
      ...
      <div class="row">
         ...
         <div class="col-lg-6">
            <div class="m-5 p-3 login-form">
              <h2 class="text-center mb-3 tilte">Candidate Login </h2>
