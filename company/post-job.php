    ...
    >
      ...
      <p class="lead text-light text-capitalize "><?php echo $_SESSION["COMPANY_NAME"]; ?></p>
        <nav class="navbar-dark">
            <ul class="navbar-nav" >
            <li>
              <a href="company_dashboard.php" class="nav-link px-3 ">
            ...
            <li>
              <a href="post-job.php" class="nav-link px-3 active">
                <span class="me-2"><i class="bi bi-graph-up"></i></span>
                <span>Post Job</span>
              </a>
            </li>
                        ...
                        <?php  
                         ...
                         <h5 class="text-success text-center">
                           <?php
                            ...
                            echo "Successfully your job posted please wait for admin approved";
                                }
                        ?> 
                    </h5>
